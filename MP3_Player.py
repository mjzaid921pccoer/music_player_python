...
#--------------------------------------------------------------------------------------------
mp3player = tk.Tk()
mp3player.geometry('600x450')
mp3player.wm_title('Music Player')
#print(mp3player.title())
#print(mp3player.winfo_screenwidth(),mp3player.winfo_screenheight())
mainMenu=tk.Menu(mp3player)
helpMenu=tk.Menu(mainMenu,tearoff=0)
helpMenu.add_command(label="About App",command=aboutGUI)
helpMenu.add_command(label="Exit",command=exitGUI)

mainMenu.add_cascade(label="Help",menu=helpMenu)
mp3player.config(menu=mainMenu)
